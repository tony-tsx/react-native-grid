    ...
    if ( Array.isArray( b ) )
      ...
      if ( b.length <= 2 ) {
        ...
        if ( Array.isArray( b[0] ) ) {
          ...
          if ( b[0][0] ) style.borderTopWidth = style.borderBottomWidth = b[0][0]
          if ( b[0][1] ) style.borderTopColor = style.borderBottomColor = b[0][1]

        } else style.borderTopWidth = style.borderBottomWidth = b[0]

        if ( Array.isArray( b[1] ) ) {

          if ( b[1][0] ) style.borderLeftWidth = style.borderRightWidth = b[1][0]
          if ( b[1][1] ) style.borderLeftColor = style.borderRightColor = b[1][1]

        } else style.borderLeftWidth = style.borderRightWidth = b[1]

      } else if ( b.length === 3 ) {

        if ( Array.isArray( b[0] ) ) {

          if ( b[0][0] ) style.borderTopWidth = b[0][0]
          if ( b[0][1] ) style.borderTopColor = b[0][1]
        ...
        if ( Array.isArray( b[2] ) ) {
          ...
          if ( b[2][0] ) style.borderBottomWidth = b[2][0]
          if ( b[2][1] ) style.borderBottomColor = b[2][1]

        } else style.borderBottomWidth = b[2]
        ...
        if ( Array.isArray( b[1] ) ) {
          ...
          if ( b[1][0] ) style.borderLeftWidth = b[1][0]
          if ( b[1][1] ) style.borderLeftColor = b[1][1]

        } else style.borderLeftWidth = b[1]
        ...
        if ( Array.isArray( b[3] ) ) {
          ...
          if ( b[3][0] ) style.borderRightWidth = b[3][0]
          if ( b[3][1] ) style.borderRightColor = b[3][1]

        } else style.borderRightWidth = b[3]

      }

    else style.borderWidth = b
